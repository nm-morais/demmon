...
while True:
  try:
    subprocess.run(["ssh", "dicluster", "ssh node6 'python3 /home/nunomorais/git/nm-morais/deMMon/scripts/visualizeLogs.py {} {}'".format(logs_folder, plot_filepath_remote)], check=True)
