...
func (l *level) increaseAtTime(amount float64, time time.Time) {
	...
	v := amount
	fmt.Printf("Adding metric %f to index %d \n", amount, index)
	l.buckets[index] = &v
}
...
// func (l *level) lastEntry() (*PointValue, error) {
// 	val := l.buckets[l.newest]
// 	if val == nil {
// 		return nil, errors.New("no value present")
// 	}
// 	return &PointValue{Time: l.latest(), Value: *val}, nil
// }
